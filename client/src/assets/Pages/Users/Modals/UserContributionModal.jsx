...
const UserContributionModal = ({ open, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("/contributions/my", {
        amount,
      ...
      Swal.fire({
        icon: "success",
        title: "Submitted",
        text: "Contribution submitted successfully and is awaiting verification.",
      });
      ...
      Swal.fire({
        icon: "error",
        title: "Error",
        text: error?.response?.data?.message || "Failed to submit contribution",
      });
    } finally {
      setLoading(false);
    }
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3">
            <p className="text-[11px] text-yellow-800">
              Your contribution will remain pending until verified by the
              administrator.
            </p>
          </div>
