...
const StatsCards = ({ dashboard }) => {
  ...
  const stats = [
    ...
    {
      title: "Total Savings",
      value: `KES ${Number(dashboard.totalSavings ?? 0).toLocaleString()}`,
    ...
    {
      title: "Active Loans",
      value: `KES ${Number(dashboard.activeLoans ?? 0).toLocaleString()}`,
    ...
    {
      title: "Chama Wallet",
      value: `KES ${Number(dashboard.chamaWallet ?? 0).toLocaleString()}`,
